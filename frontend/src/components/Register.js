      ...
      <div className="flex-1 flex items-center justify-center p-4 z-10 my-8">
        <div className="w-full max-w-[440px] bg-[#12151E] rounded-2xl border border-slate-800 shadow-[0_8px_32px_rgba(0,0,0,0.4)] px-8 py-10 sm:px-10">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold text-white mb-2 tracking-wide">Create Account</h1>
            <p className="text-sm text-slate-500">Join Codeverse and start collaborating.</p>
          </div>
          ...
          <div className="mt-8 pt-6 text-center border-t border-slate-800/80">
            <span className="text-sm text-slate-500">
              ...
              <Link to="/login" className="text-white font-semibold hover:text-cyan-400 transition-colors underline decoration-slate-700 underline-offset-4 hover:decoration-cyan-400">
                Login here
              </Link>
            </span>
          </div>
